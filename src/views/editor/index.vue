  ...
  <div>
    <header>
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-button :disabled="loadding" type="warning" @click="submit(0)">保存</el-button>
          <el-button :disabled="loadding" type="primary" @click="submit(1)">提交</el-button>
        </el-col>
      </el-row>
    </header>
    <div class="container">
      <el-row>
        <el-col :span="12">
          <textarea ref="textarea" v-model="value" :style="{ height: boxHeight + 'px' }"></textarea>
        </el-col>
        <el-col :span="12"
          ><section
            ref="markdownBody"
